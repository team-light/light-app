...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // DB作成
        warn_helper = new TestOpenHelper(getApplicationContext());
        asyncTask = new JsonAsyncTask(warn_helper.getReadableDatabase());
        asyncTask.execute();
    ...
    public void readData(String pref, String area) {
        SQLiteDatabase db = warn_helper.getReadableDatabase();
