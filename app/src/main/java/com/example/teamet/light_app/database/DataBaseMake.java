...
public class DataBaseMake extends SQLiteOpenHelper {
    ...
    public DataBaseMake(Context context){
    ...
    public void onCreate(SQLiteDatabase db){
        ...
        db.execSQL("CREATE TABLE eq_info(code INTEGER PRIMARY KEY, time TEXT DEFAULT '', hypocenter TEXT DEFAULT '', north_lat REAL, east_long REAL, depth INTEGER, magnitude REAL, max_int TEXT DEFAULT '', city_list TEXT DEFAULT '', message TEXT DEFAULT '')");
